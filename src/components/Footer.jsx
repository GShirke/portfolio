...
import { FaLinkedin, FaGithub, FaInstagram, FaWhatsapp, FaHeart } from 'react-icons/fa';

const socialIcons = [
  { icon: <FaLinkedin size={17} />, href: 'https://www.linkedin.com/in/ganesh-shirke-4b3531234', label: 'LinkedIn' },
  { icon: <FaGithub size={17} />,   href: 'https://www.github.com/GShirke',                    label: 'GitHub' },
  { icon: <FaInstagram size={17} />, href: 'https://www.instagram.com/ganesh_.shirke_?igsh=czF4aWt2N2JrYWU3', label: 'Instagram' },
  { icon: <FaWhatsapp size={17} />,  href: 'https://wa.me/7769013792',                           label: 'WhatsApp' },
];
