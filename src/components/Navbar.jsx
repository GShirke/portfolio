      ...
      >
        ...
        <ul className="hidden md:flex items-center gap-0">
          {navlinks.map((link, i) => (
            ...
            >
              ...
              >
                {link.name}
                <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 group-hover:w-4/5
        ...
        >
          <AnimatePresence mode="wait">
            {nav
              ? <motion.div key="x" initial={{ rotate: -90, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: 90, opacity: 0 }} transition={{ duration: 0.2 }}><FaTimes size={22} /></motion.div>
              : <motion.div key="bar" initial={{ rotate: 90, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: -90, opacity: 0 }} transition={{ duration: 0.2 }}><FaBars size={22} /></motion.div>
            }
          </AnimatePresence>
        </motion.div>
        ...
        <ul className="space-y-2">
          {socialMedia.map((social, i) => (
            <motion.li
              ...
              transition={{ delay: 0.8 + i * 0.1, duration: 0.5, type: 'spring', stiffness: 120 }}
