...
const contactLinks = [
  {
    ...
    label: 'ganeshshirke81923@gmail.com',
    href: 'mailto:ganeshshirke81923@gmail.com',
  },
  {
    icon: <FaLinkedin className='text-indigo-400' size={16} />,
    label: 'linkedin.com/in/ganesh-shirke',
    href: 'https://www.linkedin.com/in/ganesh-shirke-4b3531234',
  },
  {
    icon: <FaGithub className='text-indigo-400' size={16} />,
    label: 'github.com/GShirke',
    href: 'https://www.github.com/GShirke',
  },
];
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: 'Ganesh Shirke',
          from_email: form.email,
          to_email: 'ganeshshirke81923@gmail.com',
